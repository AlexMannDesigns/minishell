...
#    Updated: 2022/06/23 15:29:41 by amann            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = create_arg_list.c environment.c handle_quotes.c handle_echo.c 			\
		handle_cd.c helpers.c initialise_shell.c main.c parser.c				\
		validate_command.c	
OBJ = $(SRCS:%.c=%.o)
